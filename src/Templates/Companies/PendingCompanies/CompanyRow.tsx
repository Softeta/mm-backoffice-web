...
export const CompanyRow = ({ company, selected, onSelect }: TCompanyRow) => {
  const { name, logo, createdAt } = company;
  ...
  return (
    <div
      ...
      tabIndex={0}
    >
      <Avatar size={AvatarSizeType.Medium} title={name} imageURL={logo?.uri} />
      <div
